...
class ProjectDetector:
    ...
    def __init__(self, working_dir: str = "."):
        ...
        self.tool_definitions = {
            ProjectType.PYTHON: {
                "linter": [
                    ToolInfo("ruff", "ruff check .", "ruff check . --fix", "pyproject.toml"),
                ...
                "formatter": [
                    ...
                    ToolInfo("autopep8", "autopep8 --diff -r .", "autopep8 -r .", "setup.cfg"),
            ...
            ProjectType.JAVASCRIPT: {
                ...
                "formatter": [
                    ToolInfo("prettier", "prettier . --check", "prettier . --write", ".prettierrc"),
                ],
            },
            ProjectType.TYPESCRIPT: {
                "linter": [
                    ToolInfo("eslint", "eslint . --ext .ts,.tsx", "eslint . --ext .ts,.tsx --fix", ".eslintrc.json"),
                ],
                "formatter": [
                    ToolInfo("prettier", "prettier . --check", "prettier . --write", ".prettierrc"),
                ],
            ...
            ProjectType.RUST: {
                "formatter": [
                    ToolInfo("rustfmt", "cargo fmt -- --check", "cargo fmt", "rustfmt.toml"),
                ],
                "linter": [
        ...
        if package_json_path.exists():
            try:
                with open(package_json_path) as f:
                    ...
                    typecheck_patterns = ["typecheck", "type-check", "tsc", "type:check"]
                        ...
                        if any(p in script_name.lower() for p in lint_patterns):
                            if "linter" not in custom_tools:
                                custom_tools["linter"] = ToolInfo(
                                    ...
                                    f"npm run {script_name}:fix" if f"{script_name}:fix" in scripts else None,
                                    "package.json",
                                    is_available=True
                                )
    ...
    def _find_config_files(self) -> List[str]:
        ...
        patterns = [
            ...
            ".flake8", ".pylintrc", "mypy.ini", ".bandit",
            
            # JavaScript/TypeScript
            "package.json", "tsconfig.json", ".eslintrc*", ".prettierrc*",
            "jest.config.*", "webpack.config.*", ".babelrc*",
    ...
    def _find_source_files(self) -> List[str]:
        ...
        for dir_name in source_dirs:
            ...
            if dir_path.exists() and dir_path.is_dir():
                for ext in [".py", ".js", ".ts", ".jsx", ".tsx", ".rs", ".go", ".rb", ".java", ".cpp"]:
