...
class GitTaskManager:
    ...
    def create_task_snapshot(self, task_id: Optional[str] = None, 
        ...
        try:
            ...
            self._run_git_wip_command([git_wip_path, 'save', wip_message, '--untracked'])
        except subprocess.CalledProcessError as e:
            # Fallback: create snapshot without untracked files
            try:
                self._run_git_wip_command([git_wip_path, 'save', wip_message])
            except subprocess.CalledProcessError:
