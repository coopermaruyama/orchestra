...
class TestUserPreferenceCache(unittest.TestCase):
    ...
    def test_get_hit_returns_cached(self):
        ...
        self.cache._cache["test_key"] = cached_value
    ...
    def test_set_stores_value(self):
        ...
        self.assertEqual(self.cache._cache["test_key"], value)
    ...
    def test_lru_eviction(self):
        ...
        self.assertIn("key0", self.cache._cache)
        ...
        self.assertIn("key100", self.cache._cache)
    ...
    def test_lru_access_updates_order(self):
        ...
        self.cache._cache["key1"]  # Direct access to update order
        self.cache._cache.move_to_end("key1")
