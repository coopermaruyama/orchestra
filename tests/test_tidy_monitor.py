...
from orchestra.extensions.tidy.project_detector import ProjectType, PackageManager
...
class TestTidyMonitor(unittest.TestCase):
    ...
    def test_auto_detect_project(self, mock_detect):
        ...
        mock_project_info.detected_tools = {
            "linter": mock_linter
        }
    ...
    def test_run_checks(self, mock_factory):
        ...
        mock_runner.check.return_value = ToolResult(
            ...
            issues_count=2,
            issues=[
                {'file': 'test.py', 'line': 1, 'column': 1, 'message': 'Missing docstring'},
    ...
    def test_slash_command_init(self, mock_check, mock_confirm):
        ...
        # Mock user responses
        mock_confirm.side_effect = [False, True, True, False]  # auto_fix, strict_mode, parallel, custom_commands
