...
"""
            ...
            "calibration_data": {
                ...
                "test_file_patterns": ["tests/unit/test_*.py", "tests/integration/test_*.py"],
...
"""
    ...
    def test_analyzes_python_auth_changes(self, mock_invoke, command, real_world_python_changes):
    ...
    @patch('orchestra.common.claude_cli_wrapper.ClaudeCLIWrapper.invoke')
    def test_analyzes_react_component_changes(self, mock_invoke, command, real_world_javascript_changes):
        ...
        assert all("expect" in command.build_system_prompt(real_world_javascript_changes))
...
"""
        ...
        mock_response.content = json.dumps({
            ...
            "suggested_commands": ["pytest tests/api/test_products.py::test_search* -xvs"],
            "coverage_gaps": [
        ...
        assert all(test["test_type"] == "integration" for test in result["tests_needed"])
...
"""
        ...
        assert any(test["test_type"] == "performance" for test in result["tests_needed"])
